<template>
  <div class="w-full bg-neutral-100 relative md:p-8 p-2.5 py-24">
    <div
      ...
      <div class="md:w-1/3 w-full self-stretch md:py-5 md:pr-5 md:pl-0 p-5 flex-col justify-between items-start inline-flex">
        <div class="self-stretch h-full flex-col justify-start items-start gap-3.5 flex">
          ...
          <div class="self-stretch justify-start items-start gap-2 grid md:grid-cols-3 grid-cols-1 mt-4">
            <div
              ...
              <div class="text-white text-sm font-medium leading-tight">Suka</div>
            </div>
            <div
              ...
              <div class="text-black text-sm font-medium leading-tight">Simpan</div>
            </div>
            <div
                class="grow shrink basis-0 px-5 py-3 bg-gray-200 rounded-lg justify-center items-center gap-2 flex">
              <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="text-black text-sm font-medium leading-tight">Bagikan</div>
            </div>
          </div>
        </div>
        <div
          ...
          <div class="grow shrink basis-0 justify-start items-center gap-3 flex">
            <svg class="md:w-4 md:h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    <!--  Bagian komentar  -->
    <div class="md:flex block md:space-y-0 space-y-10 gap-5">
      <div
        ...
        <div class="self-stretch flex-col justify-start items-start gap-4 flex">
          ...
          <div class="md:w-[460px] h-[301px] relative self-stretch">
            <div class="md:w-[460px] justify-start items-start gap-2.5 inline-flex mb-4">
            ...
            <div
                class="md:w-[460px] left-[42px] relative justify-start items-start gap-2.5 inline-flex">
              <img class="w-8 h-8 relative rounded-full" src="https://via.placeholder.com/32x32" alt=""/>
              <div class="grow shrink basis-0 justify-start items-center gap-1.5 flex">
                <div
                  ...
                  <div class="flex-col justify-start items-start gap-1.5 flex">
                    <div class="justify-start items-center gap-2 inline-flex">
                      ...
                      <div
                        ...
                        <div class="text-center text-red-800 text-xs font-medium leading-none">
                          Author
                        </div>
                      </div>
                    </div>
          ...
          <div class="justify-center items-center gap-2.5 inline-flex">
            <div class="text-gray-900 text-base font-medium leading-normal underline cursor-pointer">
      ...
      <div class="md:w-1/3 w-full">
        <div
            class="w-full p-4 bg-white rounded-lg shadow border border-gray-200 items-start space-x-2 inline-flex">

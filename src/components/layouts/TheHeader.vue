        ...
        <div class="justify-end items-center gap-4 flex w-1/4">
          <div class="justify-start items-center gap-5 flex">
            ...
            <div class="lg:w-full md:w-8 sxsm:w-full">
              <button type="button"
                class="flex mr-3 text-sm md:bg-gray-800 rounded-full md:mr-0 md:focus:ring-4 md:focus:ring-gray-300"
                ...
                <svg class="w-6 h-6 md:hidden sxsm:block text-gray-800 dark:text-white" aria-hidden="true"

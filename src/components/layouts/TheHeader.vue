  ...
  <ion-header>
    <div class="w-full h-[90px] p-6 bg-white flex-col justify-center items-center inline-flex z-10">
      <div class="w-full justify-center items-center gap-8 inline-flex">
        <router-link className="md:w-1/12 md:h-3/4 sxsm:w-1/4" to="/homepage"><img class="w-full h-full"
            :src="logo" /></router-link>
        <div class="grow shrink basis-0 h-6 justify-start items-center gap-8 md:flex sxsm:hidden w-full">
        ...
        <div class="justify-end items-center gap-4 flex w-1/4">
          <div class="justify-start items-center gap-5 flex">
            <div class="w-6 h-6 relative  md:flex sxsm:hidden">
              ...
              <button type="button" id="upload-button" @click="toggleUploadDropdown">
                <svg class="lg:w-6 lg:h-6 sxsm:w-4 sxsm:h-4 text-gray-500 dark:text-white" aria-hidden="true"
            ...
            <div class="lg:w-6 lg:h-6 sxsm:w-4 sxsm:h-4 relative md:flex sxsm:hidden">
              <svg class="lg:w-6 lg:h-6 sxsm:w-4 sxsm:h-4 text-gray-500 dark:text-white" aria-hidden="true"
            ...
            <div class="lg:w-full md:w-8 sxsm:w-full">
              <button type="button"
                class="flex mr-3 text-sm md:bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                id="user-menu-button" aria-expanded="false" @click="toggleNavbarDropdown">
                <span class="sr-only">Open user menu</span>
                <img class="w-8 h-8 rounded-full md:block sxsm:hidden" src="/resources/icon.png" alt="user photo" />
                <svg class="w-6 h-6 md:hidden sxsm:block text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
              ...
              <div v-if="showNavbarDropdown"
                ...
                <div class="px-4 py-3 flex gap-2 justify-center items-center">
                  <img class="w-8 h-8 rounded-full md:hidden sxsm:block" src="/resources/icon.png" alt="user photo" />
                  <div>

            ...
            <div class="flex justify-center items-center h-screen flex-col">
                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto">
                    ...
                    <form class="space-y-6" action="#">
                        ...
                        <button type="submit" class="w-full text-white bg-red-700 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Masuk Sekarang</button>
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                            Sudah daftar? <router-link to="/login"><a class="text-red-600 hover:underline dark:text-red-600">Masuk</a></router-link>
                        </div>
                    </form>
                </div>
            </div>

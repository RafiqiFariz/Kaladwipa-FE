<template>
  <ion-page>
    <ion-content>
      <div class="md:p-8 p-4 w-full h-full bg-neutral-100">
        <h1 class="text-center font-bold">Semua Wishlist</h1>
        <div class="bg-white rounded-lg shadow-lg md:m-20 m-0 mt-5">
          <div class="justify-between place-items-center md:flex block p-3" v-for="item in wishlists" :key="item.id">
            <div class="md:flex block items-center">
              <div class="place-items-center items-center justify-center">
                <img :src="item.img" class="md:h-24 h-32 object-cover md:w-40 w-full rounded-lg" />
              </div>
              <div class="p-2">
                <h5 class="font-bold">
                  {{ item.produk }}
                </h5>
                <p class="visibility-50">Oleh {{ item.penjual }}</p>
              </div>
            </div>
            <div class="flex">
              <div class="p-4">
              ...
              <button type="button"
                ...
                <svg class="w-[15px] h-[15px] text-red-700 dark:text-white mr-2" aria-hidden="true"
                ...
                <svg class="w-[12px] h-[12px] text-red-700 dark:text-white ml-3" aria-hidden="true"
